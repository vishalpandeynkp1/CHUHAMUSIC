...
from CHUHAMUSIC import HELPABLE, Telegram, YouTube, app
from CHUHAMUSIC.misc import SUDOERS, _boot_
from CHUHAMUSIC.plugins.play.playlist import del_plist_msg
from CHUHAMUSIC.plugins.sudo.sudoers import sudoers_list
...
from CHUHAMUSIC.utils.formatters import get_readable_time
from CHUHAMUSIC.utils.functions import MARKDOWN, WELCOMEHELP
from CHUHAMUSIC.utils.inline import alive_panel, music_start_panel, start_pannel
...
"""
        ...
        try:
            ...
            CHUHA = await message.reply_text(f"**ᴅιиg ᴅσиg ꨄ︎❣️.....**")
            await CHUHA.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎.❣️....**")
            await CHUHA.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎..❣️...**")
            await CHUHA.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎...❣️..**")
            await CHUHA.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎....❣️.**")
            await CHUHA.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎.....❣️**")
            ...
            await CHUHA.delete()
            CHUHAs = await message.reply_text("**⚡ѕ**")
            await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕт**")
            # await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕтα**")
            #  await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕтαя**")
            # await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕтαят**")
            # await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕтαятι**")
            # await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕтαятιи**")
            # await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕтαятιиg**")
            # await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕтαятιиg.**")
            await asyncio.sleep(0.1)
            await CHUHAs.edit_text("**⚡ѕтαятιиg....**")
